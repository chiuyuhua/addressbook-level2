...
== Editing a person's name: 'edit name'

Edit a person's name in the addressbook through identified index.
Format: 'edit name INDEX NAME'

****
Words in 'UPPER_CASE' are the paremeters.
****
